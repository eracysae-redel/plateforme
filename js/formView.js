...
function addChildren(){
    ...
    let content = '<div class="card bg-light mx-auto mb-3" style="max-width: 30rem;">\n' +
        ...
        '                  <label class="form-check-label" for="flexSwitchCheckDefault">Dépent il/elle de votre foyer fiscal?</label>\n' +
